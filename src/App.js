    ...
    return (
      <div>
        ...
        />
          <Switch> 
          <Route exact path="/">
                <News setProgress={setProgress} apiKey={apiKey} key="genral"  pageSize = {pageSize} country="in" category="genral"/>
            </Route>
            <Route exact path="/buisness">
                <News setProgress={setProgress} apiKey={apiKey} key="buisness"  pageSize = {pageSize} country="in" category="buisness"/>
            </Route>
